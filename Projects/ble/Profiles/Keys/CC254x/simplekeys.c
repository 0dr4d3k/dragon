...
#define KEY_STATE_DESCR       "Key Press State"
#endif
 ...
 * GLOBAL VARIABLES
 */
// Configure in bcomdef.h the complete UUID for Libelium
...
/* Mirar a ver que pasa con UUID 16 128
CONST uint8 skServUUID[TI_UUID_SIZE] =
{ 
  TI_UUID(SK_SERV_UUID),
};

// Key Pressed UUID: 0x1801
CONST uint8 keyPressedUUID[TI_UUID_SIZE] =
{ 
  TI_UUID(SK_KEYPRESSED_UUID),
};
*/
...
static uint8 skCharUserDesp[16] = KEY_STATE_DESCR;
#endif

...
{
  LIBELIUM_BASE_UUID_128( OAD_SERVICE_UUID )
};

static CONST uint8 oadCharUUID[OAD_CHAR_CNT][ATT_UUID_SIZE] =
{
 // OAD Image Identify UUID
 LIBELIUM_BASE_UUID_128( OAD_IMG_IDENTIFY_UUID ),

 // OAD Image Block Request/Response UUID
 LIBELIUM_BASE_UUID_128( OAD_IMG_BLOCK_UUID )
};
   
/* oJo comprobar que pasa con UUID 128 y 16
static CONST uint8 oadServUUID[TI_UUID_SIZE] =
{
  TI_UUID( OAD_SERVICE_UUID )
};

static CONST uint8 oadCharUUID[OAD_CHAR_CNT][TI_UUID_SIZE] =
{
 // OAD Image Identify UUID
 TI_UUID( OAD_IMG_IDENTIFY_UUID ),

 // OAD Image Block Request/Response UUID
 TI_UUID( OAD_IMG_BLOCK_UUID )
};
*/  
...
#if defined OAD_BIM  // If download image is made to run in-place, enable it here.

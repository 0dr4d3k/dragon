 ...
 *  update is received.
 *
 *  Parameters for GAPPeriperalRole_SendUpdateParam() only
 */
 ...
 */
extern bStatus_t GAPPeripheralRole_SetParameter( uint16 param, uint8 len, void *pValue );
 ...
 * @return      SUCCESS or INVALIDPARAMETER (invalid paramID)
 */
extern bStatus_t GAPPeripheralRole_GetParameter( uint16 param, void *pValue );
 ...
 */
extern bStatus_t GAPPeripheralRole_StartDevice( gapPeripheralRoleCBs_t *pAppCallbacks );
 ...
 */
extern bStatus_t GAPPeripheralRole_TerminateConnection( void );
 ...
 */
extern bStatus_t GAPPeriperalRole_SendUpdateParam(uint16 minConnInterval, 
 ...
 * @return      none
 */
extern void GAPPeripheralRole_RegisterAppCBs(gapRolesParamUpdateCB_t *pParamUpdateCB);
 ...
 * @return      void
 */
extern void GAPPeripheralRole_Init( uint8 task_id );

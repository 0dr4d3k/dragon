...
#define SENSOR_SERVICE_UUID     DIGITAL_SERV_UUID
#define SENSOR_DATA_UUID        DIGITAL_DATA_UUID
#define SENSOR_CONFIG_UUID      DIGITAL_CONF_UUID
#define SENSOR_PERIOD_UUID      DIGITAL_PERI_UUID

#define SENSOR_SERVICE          DIGITAL_SERVICE
#define SENSOR_DATA_LEN         DIGITAL_DATA_LEN

#ifdef USER_DESCRIPTION
#define SENSOR_DATA_DESCR       "Digital. Data"
#define SENSOR_CONFIG_DESCR     "Digital. Conf."
#define SENSOR_PERIOD_DESCR     "Digital. Period"
#endif
 ...
 */
bStatus_t Digital_AddService( void )
{
  bStatus_t ret;
 ...
 */
bStatus_t Digital_RegisterAppCBs( sensorCBs_t *appCallbacks )
{
 ...
 * @return  bStatus_t
 */
bStatus_t Digital_SetParameter( uint8 param, uint8 len, void *value )
{
 ...
 * @return  bStatus_t
 */
bStatus_t Digital_GetParameter( uint8 param, void *value )
{
  bStatus_t ret = SUCCESS;

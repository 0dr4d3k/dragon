...
#define SENSOR_SERVICE_UUID     LUXOMETER_SERV_UUID
#define SENSOR_DATA_UUID        LUXOMETER_DATA_UUID
#define SENSOR_CONFIG_UUID      LUXOMETER_CONF_UUID
#define SENSOR_PERIOD_UUID      LUXOMETER_PERI_UUID

#define SENSOR_SERVICE          LUXOMETER_SERVICE
#define SENSOR_DATA_LEN         LUXOMETER_DATA_LEN

#ifdef USER_DESCRIPTION
#define SENSOR_DATA_DESCR       "Luxometer. Data"
#define SENSOR_CONFIG_DESCR     "Luxometer. Conf."
#define SENSOR_PERIOD_DESCR     "Luxometer. Period"
#endif
 ...
 */
bStatus_t Luxometer_AddService( void )
{
  bStatus_t ret;
 ...
 */
bStatus_t Luxometer_RegisterAppCBs( sensorCBs_t *appCallbacks )
{
 ...
 * @return  bStatus_t
 */
bStatus_t Luxometer_SetParameter( uint8 param, uint8 len, void *value )
{
 ...
 * @return  bStatus_t
 */
bStatus_t Luxometer_GetParameter( uint8 param, void *value )
{
  bStatus_t ret = SUCCESS;

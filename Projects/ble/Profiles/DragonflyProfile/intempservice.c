...
#define SENSOR_SERVICE_UUID     INTEMP_SERV_UUID
#define SENSOR_DATA_UUID        INTEMP_DATA_UUID
#define SENSOR_CONFIG_UUID      INTEMP_CONF_UUID
#define SENSOR_PERIOD_UUID      INTEMP_PERI_UUID

#define SENSOR_SERVICE          INTEMP_SERVICE
#define SENSOR_DATA_LEN         INTEMP_DATA_LEN

#ifdef USER_DESCRIPTION
#define SENSOR_DATA_DESCR       "InTemp. Data"
#define SENSOR_CONFIG_DESCR     "InTemp. Conf."
#define SENSOR_PERIOD_DESCR     "InTemp. Period"
#endif
 ...
 */
bStatus_t Intemp_AddService( void )
{
  bStatus_t ret;
 ...
 */
bStatus_t Intemp_RegisterAppCBs( sensorCBs_t *appCallbacks )
{
 ...
 * @return  bStatus_t
 */
bStatus_t Intemp_SetParameter( uint8 param, uint8 len, void *value )
{
 ...
 * @return  bStatus_t
 */
bStatus_t Intemp_GetParameter( uint8 param, void *value )
{
  bStatus_t ret = SUCCESS;

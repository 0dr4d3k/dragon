...
#define SENSOR_PERI_LEN         MAGNETOMETER_PERI_LEN

#ifdef USER_DESCRIPTION
#define SENSOR_DATA_DESCR       "Magnetometer. Data"
#define SENSOR_CONFIG_DESCR     "Magnetometer. Conf."
#define SENSOR_PERIOD_DESCR     "Magnetometer. Period"
#endif
...
static uint8 sensorData[SENSOR_DATA_LEN] = { 0, 0, 0, 0, 0, 0, 0, 0};

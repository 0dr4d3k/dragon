...
#define SENSOR_SERVICE_UUID     AIR_SERV_UUID
#define SENSOR_DATA_UUID        AIR_DATA_UUID
#define SENSOR_CONFIG_UUID      AIR_CONF_UUID
#define SENSOR_PERIOD_UUID      AIR_PERI_UUID

#define SENSOR_SERVICE          AIR_SERVICE
#define SENSOR_DATA_LEN         AIR_DATA_LEN

#ifdef USER_DESCRIPTION
#define SENSOR_DATA_DESCR       "Air. Data"
#define SENSOR_CONFIG_DESCR     "Air. Conf."
#define SENSOR_PERIOD_DESCR     "Air. Period"
#endif
 ...
 */
bStatus_t Air_RegisterAppCBs( sensorCBs_t *appCallbacks )
{
 ...
 * @return  bStatus_t
 */
bStatus_t Air_SetParameter( uint8 param, uint8 len, void *value )
{
 ...
 * @return  bStatus_t
 */
bStatus_t Air_GetParameter( uint8 param, void *value )
{
  bStatus_t ret = SUCCESS;

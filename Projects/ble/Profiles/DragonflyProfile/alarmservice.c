...
#define SENSOR_SERVICE_UUID     ALARM_SERV_UUID
#define SENSOR_DATA_UUID        ALARM_DATA_UUID
#define SENSOR_CONFIG_UUID      ALARM_CONF_UUID
#define SENSOR_PERIOD_UUID      ALARM_PERI_UUID

#define SENSOR_SERVICE          ALARM_SERVICE
#define SENSOR_DATA_LEN         ALARM_DATA_LEN

#ifdef USER_DESCRIPTION
#define SENSOR_DATA_DESCR       "Alarm. Data"
#define SENSOR_CONFIG_DESCR     "Alarm. Conf."
#define SENSOR_PERIOD_DESCR     "Alarm. Period"
#endif
...
static uint8 sensorDataProps = GATT_PROP_READ | GATT_PROP_READ | GATT_PROP_NOTIFY;
 ...
 */
bStatus_t Alarm_AddService( void )
{
  bStatus_t ret;
 ...
 */
bStatus_t Alarm_RegisterAppCBs( sensorCBs_t *appCallbacks )
{
 ...
 * @return  bStatus_t
 */
bStatus_t Alarm_SetParameter( uint8 param, uint8 len, void *value )
{
 ...
 * @return  bStatus_t
 */
bStatus_t Alarm_GetParameter( uint8 param, void *value )
{
  bStatus_t ret = SUCCESS;

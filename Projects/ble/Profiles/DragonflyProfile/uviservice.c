...
#define SENSOR_SERVICE_UUID     UVI_SERV_UUID
#define SENSOR_DATA_UUID        UVI_DATA_UUID
#define SENSOR_CONFIG_UUID      UVI_CONF_UUID
#define SENSOR_PERIOD_UUID      UVI_PERI_UUID

#define SENSOR_SERVICE          UVI_SERVICE
#define SENSOR_DATA_LEN         UVI_DATA_LEN

#ifdef USER_DESCRIPTION
#define SENSOR_DATA_DESCR       "UVi. Data"
#define SENSOR_CONFIG_DESCR     "UVi. Conf."
#define SENSOR_PERIOD_DESCR     "UVi. Period"
#endif
 ...
 */
bStatus_t UVi_RegisterAppCBs( sensorCBs_t *appCallbacks )
{
 ...
 * @return  bStatus_t
 */
bStatus_t UVi_SetParameter( uint8 param, uint8 len, void *value )
{
 ...
 * @return  bStatus_t
 */
bStatus_t UVi_GetParameter( uint8 param, void *value )
{
  bStatus_t ret = SUCCESS;

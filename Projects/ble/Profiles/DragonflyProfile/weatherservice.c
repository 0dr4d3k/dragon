...
#define SENSOR_SERVICE_UUID     WEATHER_SERV_UUID
#define SENSOR_DATA_UUID        WEATHER_DATA_UUID
#define SENSOR_CONFIG_UUID      WEATHER_CONF_UUID
#define SENSOR_PERIOD_UUID      WEATHER_PERI_UUID

#define SENSOR_SERVICE          WEATHER_SERVICE
#define SENSOR_DATA_LEN         WEATHER_DATA_LEN

#ifdef USER_DESCRIPTION
#define SENSOR_DATA_DESCR       "Weather. Data"
#define SENSOR_CONFIG_DESCR     "Weather. Conf."
#define SENSOR_PERIOD_DESCR     "Weather. Period"
#endif
 ...
 */
bStatus_t Weather_AddService( void )
{
  bStatus_t ret;
 ...
 */
bStatus_t Weather_RegisterAppCBs( sensorCBs_t *appCallbacks )
{
 ...
 * @return  bStatus_t
 */
bStatus_t Weather_SetParameter( uint8 param, uint8 len, void *value )
{
 ...
 * @return  bStatus_t
 */
bStatus_t Weather_GetParameter( uint8 param, void *value )
{
  bStatus_t ret = SUCCESS;

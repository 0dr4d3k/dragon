...
#define SBP_PERIODIC_EVT                                  0x0040
 ...
 */
extern void NeopixelApp_Init( uint8 task_id );

/*
 * Task Event Processor for the BLE Application
 */
extern uint16 NeopixelApp_ProcessEvent( uint8 task_id, uint16 events );

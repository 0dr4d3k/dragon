...
cmd /C cc254x_ubl_pp.js "ProdUBL" "o:\work_dragonfly\dragonfly_iar_assembla_trunk_103\Projects\ble\dragonfly\CC2541DF\CC2541DF-DragonFly-OAD-ImgA\Exe\DragonFly.sim"

 ...
 *                                       Board Indentifier
 *
 *      Define the Board Identifier to HAL_BOARD_DRAGONFLY_v7
 * ------------------------------------------------------------------------------------------------
 */

#if !HAL_BOARD_DRAGONFLY_v7
#define HAL_BOARD_DRAGONFLY_v7
#endif
...
/* Accelerometer interrupt INT1*/
#define ACC_INT1_BV        BV(7)
#define ACC_INT1_SBIT      P1_7
#define ACC_INT1_DDR       P1DIR
#define ACC_INT1_SEL       P1SEL

/* Accelerometer interrupt INT2*/
#define ACC_INT2_BV        BV(6)
#define ACC_INT2_SBIT      P1_6
#define ACC_INT2_DDR       P1DIR
#define ACC_INT2_SEL       P1SEL
...
{                                                                              \
  ...
  P0DIR |= 0xC7;           /* Unused pin as output 0b11000111*/  \
  P2DIR |= 0x01;           /* Unused pin as output */            \
  P1DIR |= 0x3F;           /* UART pins as output 0b00111111*/   \
  P0INP =  0x38;           /* Tri-state inputs 0b00111000*/      \
}
//--------------aqui me quedo
//  P2INP |= 0x20;           /* Pull-DOWN for port 0*/      \
//  P0INP =  0x00;           /* Pull-DOWN inputs 0b00000000*/      \
//  P0INP =  0x00;           /* Pull-UP inputs 0b00000000*/      \

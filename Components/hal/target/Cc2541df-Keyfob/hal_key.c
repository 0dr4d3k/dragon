...
/* CPU port interrupt */
#define HAL_KEY_CPU_PORT_0_IF P0IF /* IRCON (0xC0) – bit 5 - Por0 interruption pending */
//#define HAL_KEY_CPU_PORT_1_IF P1IF /* IRCON2 (0xE8) – bit 3 - Por1 interruption pending */
#define HAL_KEY_CPU_PORT_2_IF P2IF /* IRCON2 (0xE8) – bit 5 - Por2 interruption pending */

//#if defined ( HAL_BOARD_DRAGONFLY_v7 )
/* SW_1 is at P0.3 */
...
/* SW_3 is INT1 at P1.7 */
#define HAL_KEY_SW_3_PORT   P1
#define HAL_KEY_SW_3_BIT    BV(7)
#define HAL_KEY_SW_3_SEL    P1SEL
#define HAL_KEY_SW_3_DIR    P1DIR

#define HAL_KEY_SW_1_IEN      IEN1  /* IEN1 (0xB8) – Interrupt Enable 1. CPU interrupt mask register */
#define HAL_KEY_SW_1_IENBIT   BV(5) /* Mask bit for all of Port_0 */
#define HAL_KEY_SW_1_ICTL     P0IEN /* P0IEN (0xAB) – Port 0 Interrupt Mask. Port Interrupt Control register */
#define HAL_KEY_SW_1_ICTLBIT  BV(3) /* P0IEN - P0.3 enable/disable bit */
#define HAL_KEY_SW_1_PXIFG    P0IFG /* RP0IFG (0x89) – Port 0 Interrupt Status Flag. Interrupt flag at source */
...
#define HAL_KEY_SW_2_ICTLBIT  BV(4) /* P0IEN - P0.4 enable/disable bit */
#define HAL_KEY_SW_2_PXIFG    P0IFG /* Interrupt flag at source */

#define HAL_KEY_SW_3_IEN      IEN2  /* IEN2 (0x9A) – Interrupt Enable 2. CPU interrupt mask register */
#define HAL_KEY_SW_3_IENBIT   BV(4) /* Mask bit for all of Port_1 */
#define HAL_KEY_SW_3_ICTL     P0IEN /* P1IEN (0x8D) – Port 1 Interrupt Mask. Port Interrupt Control register */
#define HAL_KEY_SW_3_ICTLBIT  BV(7) /* P1IEN - P1.7 enable/disable bit */
#define HAL_KEY_SW_3_PXIFG    P0IFG /* P1IFG (0x8A) – Port 1 Interrupt Status Flag. Interrupt flag at source */

/* For use with PICTL (0x8C) – Port Interrupt Control */
#define HAL_KEY_SW_1_EDGEBIT  BV(0) /* Port 0, inputs 7 to 0 interrupt configuration as falling edge */
#define HAL_KEY_SW_3_EDGEBIT  BV(3) /* Port 1, inputs 7 to 4 interrupt configuration as falling edge */
...
//#if defined ( HAL_BOARD_DRAGONFLY_v7 )
  ...
  PICTL |= HAL_KEY_SW_3_EDGEBIT;   /* Set the edge bit to set falling edge to give int */
...
//#if !defined ( HAL_BOARD_DRAGONFLY_v7 )
#if FALSE  //VER COMO ADQUIERE EL DATO ANAOGICO
/**************************************************************************************************

...
/* Gyro interrupt */
#define GYRO_INT_BV       BV(7)
#define GYRO_INT_SBIT     P1_7
#define GYRO_INT_DDR      P1DIR

/* IR temp data ready */
#define IRTEMP_DRDY_BV    BV(7)
#define IRTEMP_DRDY_SBIT  P1_7
#define IRTEMP_DRDY_DDR   P1DIR

/* Magnetometer interrupt */
#define MAG_INT_BV        BV(7)
#define MAG_INT_SBIT      P1_7
#define MAG_INT_DDR       P1DIR
...
#define ACC_INT_BV        BV(7)
#define ACC_INT_SBIT      P1_7
#define ACC_INT_DDR       P1DIR
#define ACC_INT_SEL       P1SEL

...
#define HAL_KEY_SW_2_ICTLBIT  BV(4) /* P0IEN - P0.0 enable/disable bit */
...
#define HAL_KEY_SW_3_ICTLBIT  BV(5) /* P0IEN - P0.0 enable/disable bit */
...
#define HAL_KEY_SW_2_3_EDGEBIT  BV(0)

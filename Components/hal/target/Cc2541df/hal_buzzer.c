...
void HalBuzzerInit( void )
{
  ...
  BUZZER_DDR |= (uint8) HAL_BUZZER_P1_OUTPUT_PINS;
}
...
//  P1SEL |= (uint8) HAL_BUZZER_P1_GPIO_PINS;
  BUZZER_SEL |= (uint8) HAL_BUZZER_P1_GPIO_PINS;
...
//    T4CTL = HAL_T4_TIMER_CTL_DIV64 |
    ...
    T4CC0 = 135; //For Chanel 0(P1_0) and 1(P1_1) when in OPMODE_MODULO 
  }
...
//    T4CTL = HAL_T4_TIMER_CTL_DIV32 |
      T4CTL = HAL_T4_TIMER_CTL_DIV32 |
            HAL_T4_TIMER_CTL_CLEAR |
            HAL_T4_TIMER_CTL_OPMODE_MODULO;
    T4CC0 = 115; //For Chanel 0(P1_0) and 1(P1_1) when in OPMODE_MODULO 
  }

//  T4CCTL0 = HAL_T4_TIMER_CCTL_MODE_COMPARE | HAL_T4_TIMER_CCTL_CMP_TOGGLE; //Chanel 0 P1_0
  T4CCTL1 = HAL_T4_TIMER_CCTL_MODE_COMPARE | HAL_T4_TIMER_CCTL_CMP_TOGGLE; //Chanel 1 P1_1
...
/**************************************************************************************************
**************************************************************************************************/
#endif // (defined HAL_BUZZER) && (HAL_BUZZER == TRUE)